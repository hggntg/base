...
function createHooks(namespace) {
    ...
    var asyncHook = asyncHooks.createHook({ init: init, destroy: destroy });
    asyncHook.enable();
}
var Namespace = (function () {
    ...
    Namespace.prototype.remove = function (key) {
        var eid = asyncHooks.executionAsyncId();
        this.context[eid][key] = default_value_1.defaultValue(this.get(key));
    };
    Namespace.prototype.dispose = function () {
        this.context = default_value_1.defaultValue(this.context);
    };
